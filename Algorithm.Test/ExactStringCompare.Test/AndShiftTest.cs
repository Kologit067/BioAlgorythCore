...
namespace ExactStringCompareTest
{
    ...
    public class AndShiftTest
    {
        ...
        public void ProcessInputDataAndShiftTestLength7Number3Pattern4Step987()
        {
            ...
            int textLength = 14;
            char[] alphabet = new char[] { 'a', 'c', 'g', 't' };
            StringCompareAccumulator statisticAccumulator = new StringCompareAccumulator(new StringCompareSaver(), BoyerMooreComparer.AlgorithmNameBadSymbolAdv,
    ...
    public class EnumerateCharSetForAndShift : EnumerateIntegerCharSet
    {
            ...
            : base(pCharSet, pTextLength + pPatternLength, 0)
        {
            ...
            _step = pStep;
            _stepCounter = 1;
            _statisticAccumulator = new StringCompareAccumulator(new StringCompareSaver(), AndShift.AlgorithmName,
