...
using BioAlgorithm.RepresentativesModel;
...
namespace BioAlgorithmViewModel.Representatives
{
    ...
    {
        private readonly RepresentativesRepository representativesRepository;
        //----------------------------------------------------------------------------------------------------------------------
        ...
        private async void RefreshRepresentativePerformanceListAction()
        {
            ...
            List<RepresentativesPerfomance> rp = await representativesRepository.GetRepresentativePerformanceListAsync(
